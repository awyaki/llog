...
export const SelectedTagsForHandleNoteContext =
  createContext<ProvidedSelectedTagsForHandleNoteContext>({
...
export const SelectedTagsForHandleNoteContextProvider: FC = ({ children }) => {
  const [selectedTagsForHandleNote, setSelectedTagsForHandleNote] = useState<
    Tag[]
  >([]);
