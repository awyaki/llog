...
import { EnterIcon, CancelIcon, NotifierContext } from "~/components";
...
export const ContentBlocksForm: VFC<Props> = ({
  ...
  const isLarger = useCallback<Validate<string>>((newMaxUnitNumber) => {
    ...
    return (
      isOk || "The input number should be larger than the original number."
    );
  }, []);
        ...
        <input
          ...
          {...register("newMaxUnitNumber", {
            ...
            min: {
              value: 1,
              message:
                "You should fill in this field with a number which is equal to or more than 1.",
            },
            max: {
              value: 3000,
              message: `You should fill in this field with a number which is equal to or less than 3000.`,
