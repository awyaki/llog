...
export const LatestIsBottomIcon: VFC<Props> = ({ active }) => {
  ...
  return (
    <svg width="51px" height="51px" viewBox="0 0 51 51" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <g id="コンテンツ" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="コンテンツ（リスト）1デフォルト" transform="translate(-795.000000, -269.000000)">
                <g id="Group-10" transform="translate(638.000000, 155.000000)">
                    <g id="Group-17" transform="translate(182.500000, 139.500000) rotate(90.000000) translate(-182.500000, -139.500000) translate(157.000000, 114.000000)">
