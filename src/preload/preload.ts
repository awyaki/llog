...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  createContent: (name: string, tags: Tag[], blocksNumber: number) =>
    ipcRenderer.invoke("createContent", name, tags, blocksNumber),
  ...
  updateContentName: ({ id, name }: Pick<Content, "id" | "name">) =>
    ipcRenderer.invoke("updateContentName", { id, name }),
  createNote: (
    mkd: string,
    transformed: string,
    tags: Tag[],
  ...
  getNoteWithContentId: (contentId: number) =>
    ipcRenderer.invoke("getNoteWithContentId", contentId),
  ...
  ) => ipcRenderer.invoke("updateBlock", block),
  getAllBlock: () => ipcRenderer.invoke("getAllBlock"),
  updateContentTags: (id: number, tags: Tag[]) =>
    ipcRenderer.invoke("updateContentTags", id, tags),
  upsertContentBlocks: (
    id: number,
  ...
  deleteConnectContentTags: (id: number) =>
    ipcRenderer.invoke("deleteConnectContentTags", id),
  deleteContent: (id: number) => ipcRenderer.invoke("deleteContent", id),
  markdownToHTML: (markdown: string) =>
    ipcRenderer.invoke("markdownToHTML", markdown),
  updateLogTitle: (id: number, title: string) =>
    ipcRenderer.invoke("updateLogTitle", id, title),
